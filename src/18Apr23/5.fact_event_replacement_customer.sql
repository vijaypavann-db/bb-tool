...
DELETE FROM DWH.FACT_EVENT_REPLACEMENT_CUSTOMER where event_date_pt = '{start_date}'  ;

INSERT INTO DWH.FACT_EVENT_REPLACEMENT_CUSTOMER
    (source_file_folder ,
    source_file_name ,
    data_source ,
...
SELECT
    ...
    order_delivery_id,
    order_item_id,
    i.value:display_position::NUMBER as item_card_impression_display_position,
    ...
    i.value:grid_row::NUMBER as item_card_impression_grid_row,
    i.value:item_card_impression_id::VARCHAR as item_card_impression_id,
    i.value:grid_column::NUMBER as item_card_impression_grid_column,
    i.value:item_id::NUMBER as item_card_impressions_item_id,
