...
-- If doing backfill for data before 2020 July, please add the following commented out code.
...
-- -- -- -- -- -- -- Conversion -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
DELETE FROM dwh.fact_event_replacement_conversion;
...
-- -- -- -- -- -- -- View -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
DELETE FROM dwh.fact_event_replacement_view;
